...
def character_setup_from_ue4(jnt):
    ...
    if settings_file_name:
        ...
        file_ops.load_settings_from_json(character_network.group, settings_file, settings_binding.Binding_Sets.ZERO_ORIENT_ALL.value)
    
    else:
        file_ops.load_settings_from_json_with_dialog(character_network.group, settings_binding.Binding_Sets.ZERO_ORIENT_ALL.value)
