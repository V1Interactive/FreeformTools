...
class ContentBrowser(object):
    ...
    def __init__(self, file_path = None):
        ...
        if "maya" in self.process.ToString():
            ...
            import scene_tools
            scene_tools.scene_manager.SceneManager.update_method_list.append(self.content_browser_get_files)
    ...
    def close(self, vm, event_args):
        ...
        if "maya" in self.process.ToString():
            import scene_tools
            scene_tools.scene_manager.SceneManager().remove_method(self.content_browser_get_files)
    ...
    def content_browser_get_files(self):
        return [x.ItemPath for x in self.vm.ContentListViewSource.View if type(x) == Freeform.Rigging.ContentBrowser.UserFile]
